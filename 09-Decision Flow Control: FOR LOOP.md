...
```python
# Python sequences
text = "Python"  # this is s sequence of characters
languages = ['English', 'French', 'German'] # this is a sequence of words.
```
...
for character in text: # explain the syntax here, `for i in text:` will also work
    print(character)
```
...
```python
languages = ["English", "French", "German"] # collection of languages
